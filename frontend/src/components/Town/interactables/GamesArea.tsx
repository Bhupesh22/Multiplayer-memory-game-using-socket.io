...
import MemoryGameArea from './MemoryGame/MemoryGameArea';
 ...
 *  - The game area component (either ConnectFourArea, TicTacToeArea, or MemoryGameArea). If the game area is NOT a ConnectFourArea, TicTacToeArea, or MemoryGameArea then the message INVALID_GAME_AREA_TYPE_MESSAGE appears within the component
  ...
  return (
    <>
      <Accordion allowToggle>
        {gameAreaController.id == 'MemoryGame' ? (
          <AccordionItem>
            <Heading as='h3'>
              <AccordionButton>
      ...
      <Flex>
        <Box>
          ...
          ) : gameAreaController.toInteractableAreaModel().type === 'MemoryGameArea' ? (
            <MemoryGameArea interactableID={interactableID} />
          ) : (
