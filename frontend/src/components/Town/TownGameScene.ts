...
import LeaderboardArea from './interactables/Leaderboard/LeaderboardAreaPhaser';
...
export default class TownGameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image(
      'Custom_Assets_32x32',
      this._resourcePathPrefix + '/assets/tilesets/Custom_Assets_32x32.png',
    );
