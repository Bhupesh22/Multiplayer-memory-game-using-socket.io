...
export default class PlayerController extends (EventEmitter as new () => TypedEmitter<PlayerEvents>) {
  ...
  constructor(id: string, userName: string, location: PlayerLocation, isAdmin?: boolean) {
    super();
    this._id = id;
  ...
  toPlayerModel(): PlayerModel {
    return { id: this.id, userName: this.userName, location: this.location, isAdmin: this.isAdmin };
  }
  ...
  static fromPlayerModel(modelPlayer: PlayerModel): PlayerController {
    return new PlayerController(
      ...
      modelPlayer.isAdmin ? modelPlayer.isAdmin : false,
    );
  }
}
